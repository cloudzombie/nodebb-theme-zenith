...
class="col-md-6 col-sm-12 col-xs-12 list-item clearfix">
	...
	<div class="image">
		...
		src="https://vectr.com/cloud/designs/welcome">
	...
	<div class="meta">
		...
		<div class="buttons">
			<a class="button facebook" href="http://www.facebook.com/share.php?u=http://cannalmanac.com/category/{../slug}">
				<span>Share</span>
			</a>
			<a class="button twitter" href="http://twitter.com/share?url=http://cannalmanac.com/category/{../slug}&text={../name}">
				<span>Share</span>
			</a>
		</div>
